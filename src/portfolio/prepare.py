...
def materialize_run(app: AppConfig) -> Path:
    ...
    explicit_sides = {k: v for k, v in (port.position_sides or {}).items() if k in tickers}
    position_sides = effective_position_sides(app, tickers) or explicit_sides or None
    ...
    manifest = {
        ...
        "weighting": weighting,
        "sentiment_position_sides": port.sentiment_position_sides,
