...
- Portfolio weights: `src/portfolio/prepare.py`, `src/portfolio/weights.py`, `src/risk/portfolio/holdings.py` (`load_portfolio_weights` for UI/analytics) — [portfolio_dashboard.md](portfolio_dashboard.md)
